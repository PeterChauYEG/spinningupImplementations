import spinupImplementation
from spinupImplementation.utils.run_utils import ExperimentGrid
...
if __name__ == '__main__':
    ...
    valid_algos = ['trpo', 'trpoImplementation', 'vpg', 'vpgImplementation']
    ...
    if cmd in valid_help:
        ...
        help_msg = dedent("""
            ...
            \tpython -m spinupImplementation.run CMD [ARGS...]
        ...
        special_info = dedent("""
            ...
            \tpython -m spinupImplementation.run ppo --env HalfCheetah-v2 --clip_ratio 0.1

            If you need a quick refresher on valid kwargs, get the docstring
            with

            \tpython -m spinupImplementation.run [algo] --help
